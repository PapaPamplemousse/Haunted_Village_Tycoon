...
TileType tileTypes[TILE_MAX] = {
    ...
    [TILE_WATER] = {.name         = "Water",
                    ...
                    .texture      = {0},
                    .texturePath  = "assets/textures/water.png",
                    .isBreakable  = false,
                    .durability   = 100,
                    .movementCost = 100.0f,
                    .humidity     = 1.0f,
    ...
    [TILE_LAVA] = {.name         = "Lava",
                   ...
                   .texture      = {0},
                   .texturePath  = "assets/textures/lava.png",
                   .isBreakable  = false,
                   .durability   = 100,
                   .movementCost = 100.0f,
                   .humidity     = 0.0f,
    ...
    [TILE_FOREST] = {.name         = "Forest",
                     ...
                     .texture      = {0},
                     .texturePath  = "assets/textures/forest.png",
                     .isBreakable  = false,
                     .durability   = 100,
                     .movementCost = 1.5f,
                     .humidity     = 0.8f,
    ...
    [TILE_PLAIN] = {.name         = "Plain",
                    ...
                    .texture      = {0},
                    .texturePath  = "assets/textures/plain.png",
                    .isBreakable  = false,
                    .durability   = 100,
                    .movementCost = 1.0f,
                    .humidity     = 0.5f,
    ...
    [TILE_SAVANNA] = {.name         = "Savanna",
                      ...
                      .texture      = {0},
                      .texturePath  = "assets/textures/savana.png",
                      .isBreakable  = false,
                      .durability   = 100,
                      .movementCost = 1.2f,
                      .humidity     = 0.3f,
    ...
    [TILE_HELL] = {.name         = "Hell",
                   ...
                   .texture      = {0},
                   .texturePath  = "assets/textures/hell.png",
                   .isBreakable  = false,
                   .durability   = 100,
                   .movementCost = 3.0f,
                   .humidity     = 0.0f,
    ...
    [TILE_CURSED_FOREST] = {.name         = "Cursed_Forest",
                            ...
                            .texture      = {0},
                            .texturePath  = "assets/textures/cursed_forest.png",
                            .isBreakable  = false,
                            .durability   = 100,
                            .movementCost = 2.5f,
                            .humidity     = 0.7f,
    ...
    [TILE_SWAMP] = {.name         = "Swamp",
                    ...
                    .texture      = {0},
                    .texturePath  = "assets/textures/swamp.png",
                    .isBreakable  = false,
                    .durability   = 100,
                    .movementCost = 3.0f,
                    .humidity     = 0.9f,
    ...
    [TILE_DESERT] = {.name         = "Desert",
                     ...
                     .texture      = {0},
                     .texturePath  = "assets/textures/desert.png",
                     .isBreakable  = false,
                     .durability   = 100,
                     .movementCost = 1.3f,
                     .humidity     = 0.1f,
    ...
    [TILE_MOUNTAIN] = {.name         = "Mountain",
                       ...
                       .texture      = {0},
                       .texturePath  = "assets/textures/mountain.png",
                       .isBreakable  = true,
                       .durability   = 500,
                       .movementCost = 100.0f,
                       .humidity     = 0.2f,
